...
app.config['SESSION_TYPE'] = 'filesystem'  # Wartość 'filesystem' oznacza przechowywanie sesji na dysku
app.config['SESSION_USE_SIGNER'] = True  # Włącza podpisywanie sesji, co zwiększa bezpieczeństwo
...
def login_user_in_session(client_number):
    ...
    if session_id:
        ...
        unique_string = f"{request.remote_addr}{request.user_agent}{secrets.token_hex(16)}"
        print(unique_string)
